...
var MultipleComponent = (function (_super) {
    ...
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "name");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "classe");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "placeholder");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "templateResultado");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "templateSelecionado");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "templateSemResultado");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "indiceId");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "indiceNome");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "valores");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "change");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onSelecionarItem");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onBuscar");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onApagar");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onRemoverItem");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onAbrir");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onFechar");
    __decorate([
        core_1.Output()
    ], MultipleComponent.prototype, "onLimpar");
    __decorate([
        core_1.ViewChild('campoBusca')
    ], MultipleComponent.prototype, "campoBusca");
    __decorate([
        core_1.Input()
    ], MultipleComponent.prototype, "value");
